...
module.exports = () => {
    ...
    let shop = {};
    const titleList = ['霸王牛肉面233444fffgit·专业面食外卖', '鸡将军黄焖鸡23334444（高新店)', '赵家腊汁肉（高新旗舰店）', '这家店不错牛肉面', '神龙冒菜', '川魂冒牌冒菜', '小竹签烤肉（枫韵蓝湾店）', '大自在火锅（丰庆店）', '老碗（太白店）', '乍见之欢炒菜馆','麻辣私厨','一品小厨','川湘源川菜馆',
        '霸王牛肉面·专业面食外卖', '鸡将军黄焖鸡（高新店4444）', '赵家腊汁肉（高新旗舰店44444）', '这家店不错牛肉面', '神龙冒菜', '川魂冒牌冒菜', '小竹签烤肉（枫韵蓝湾店）','霸王牛肉面·专业面食外卖', '鸡将军黄焖鸡（高新店）', '赵家腊汁肉（高新旗舰店）', '这家店不错牛肉面', '神龙冒菜', '川魂冒牌冒菜', '小竹签烤肉（枫韵蓝湾店' ,
    ...
    let hongbao = [
        ...
        },
        {
            amount:10,
            begin_date:"2017-7-12T00:00:00+0800",
            description: ["满30元可用", "限尾号 6055 的手机使用", "2017-07-12 至 2017-07-17"],
        ...
        },
        {
            amount:10,
            begin_date:"2017-7-12T00:00:00+0800",
            description: ["满30元可用", "限尾号 6055 的手机使用", "2017-07-12 至 2017-07-07"],
        ...
        },
        {
            amount:20,
            begin_date:"2017-7-12T00:00:00+0800",
            description: ["满50元可用", "限尾号 6055 的手机使用", "2017-07-12 至 2017-07-09"],
            end_date: "2017-7-09T23:59:59+0800",
            hongbao_type: "GENERAL",
            id:15,
            name: "普通红包",
            sn: "201707120207253677157364366624",
