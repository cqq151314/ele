            ...
            <div>
                <div className="footer">
                    <div className="footer-link">
                        <h3>用户帮助</h3>
                        <a href="http://www.ele.me" target="_blank">服务中心</a>
                        <a href="http://www.ele.me" target="_blank">常见问题</a>
                        <a href="http://www.ele.me" target="_blank">在线客服</a>
                    </div>
                    <div className="footer-link">
                        <h3>商务合作</h3>
                        <a href="http://www.ele.me" target="_blank">我要开店</a>
                        <a href="http://www.ele.me" target="_blank">加盟指南</a>
                        <a href="http://www.ele.me" target="_blank">市场合作</a>
                        <a href="http://www.ele.me" target="_blank">开放平台</a>
                    </div>
                    <div className="footer-link">
                        <h3>关于我们</h3>
                        <a href="http://www.ele.me" target="_blank">饿了么介绍</a>
                        <a href="http://www.ele.me" target="_blank">加入我们</a>
                        <a href="http://www.ele.me" target="_blank">联系我们</a>
                        <a href="http://www.ele.me" target="_blank">规则中心</a>
                    </div>
